...
unsigned int inline do_div(int *ptr, unsigned int base) 
{ 
	int res;
	res = ((unsigned int) *ptr) % (unsigned int) base; 
	*ptr = ((unsigned int) *ptr) / (unsigned int) base; 
	return res; 
}
